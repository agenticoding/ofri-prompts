...
- Does the changeset correctly match the PR description?  Verify changes match the described intent and that no additions, removals or changes went unnoticed.
...
- Is documentation present inline when necessary? Are the full what, why, and how fully recoverable from the code?
