...
**CONSTRAINTS:**
- The human-optimized markdown file should be under 1k tokens
  - **Format the changes so it's easy for a human to spot additions, removals and changes.**
  - **Focus on the intent and value proposition, NOT on the mechanical diffs.**
  - Ensure coherent storytelling that's easy to reason about
